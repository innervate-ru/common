...
// !!! Zork: Этот класс я не стал сильно переделывать под services, так как в ближайшее время планирую перейти на embedded бызу, которые заменят эту реализацию
 ...
 */
export default class CachedResponsesService {
