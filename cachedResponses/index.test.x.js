...
// services.console = require('../utils/testConsole');
// */
//
// function TestSvc(services) {
//
//   class TestSvc extends require('./index').CachedResponsesService(services) {
//
//     __loadCount = 0;
//     __time = 1000;
//
...
//   }
//
//   return (require('../../common/services').Service(services)(TestSvc));
// }
//
// async function getSVC(opts) {
//   const svc = new TestSvc(opts);
//   return svc;
// }
//
